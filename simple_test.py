...
if __name__ == "__main__":
    ...
    parser.add_argument('--urls', nargs='+', 
                        default=['http://localhost:6006/tts'],  # , 'http://localhost:11997/tts'
    ...
    parser.add_argument('--concurrency', type=int, default=2, help='并发线程数')
    parser.add_argument('--requests', type=int, default=1, help='每个线程的请求数')
